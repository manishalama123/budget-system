...
A simple **Budget Management System** built using **Django** (backend) and **JavaScript** (frontend).  
It helps users manage their income, expenses, and view visual summaries using **Chart.js**.
